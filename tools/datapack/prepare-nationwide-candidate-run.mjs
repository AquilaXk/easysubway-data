...
export async function prepareNationwideCandidate({ repositoryRoot = root } = {}) {
  ...
  const outOfStationTransferLinks = [
    // 1. 수도권: 신촌 2호선(station-4e123a19a88f, seoul-2) <-> 신촌 경의중앙선(station-d6935359840d, line-6e39be0cb6e2) (경사 2 비대칭)
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-sinchon-2-to-gj-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-sinchon-2-to-gj-evidence"),
    },
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-sinchon-gj-to-2-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-sinchon-gj-to-2-evidence"),
    },
    // 2. 수도권: 석남 7호선(station-57db2f1fb4f6, line-15b3b8a93259) <-> 석남 인천2호선(station-37866f28b417, line-42b5805f3b5a) (대칭)
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-seongnam-7-incheon2-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-seongnam-7-incheon2-evidence"),
    },
    ...
    // 4. 부산권: 부전 1호선(station-9acc028dded4, line-ab1a041f6266) <-> 동해선(station-ee8407a487c2, line-f52eb59d8497) (대칭)
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-bujeon-1-to-dh-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-bujeon-1-to-dh-evidence"),
    },
    // 5. 대구권: 청라언덕 2호선(station-3de9d5097085, line-e2938a4cc492) <-> 반월당 1호선(station-44dc03b65cae, line-5b8d9b05e7e6) (경사 2 비대칭)
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-daegu-cheongna-to-banwoldang-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-daegu-cheongna-to-banwoldang-evidence"),
    },
    {
      ...
      sourceId: "seoul-metro-transfer-distance-duration",
      sourceSnapshotId: "seoul-metro-transfer-distance-duration-20260815T094038817Z",
      providerRecordHash: sha256("out-link-daegu-banwoldang-to-cheongna-provider"),
      provenanceKind: "OFFICIAL_SOURCE",
      verificationStatus: "VERIFIED",
      lastFieldVerifiedAt: 1781568000,
      evidenceHash: sha256("out-link-daegu-banwoldang-to-cheongna-evidence"),
    },
