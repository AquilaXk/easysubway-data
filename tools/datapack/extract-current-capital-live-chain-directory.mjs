...
export async function extractCurrentCapitalLiveChainDirectory({ ociPlanBytes, externalReceiptBytes, fetchedBundleBytes, destinationDirectory, repository, repositorySha, operationId, outputPaths, failBeforeRename = false }) {
  ...
  const bundle = readCurrentCapitalLiveChainBundle(fetchedBundleBytes, { repository, repositorySha, operationId, outputPaths });
