...
// seoul-metro 1~8 route_map_positions를 닫지 못하므로 이번 FILE admission이 +8을 만든다.
const DAEGU_ACCESSIBILITY_BASELINE_SUPPORTED_COUNT = 34;
const SEOUL_ROUTE_MAP_SUPPORTED_COUNT = DAEGU_ACCESSIBILITY_BASELINE_SUPPORTED_COUNT + 8;
...
async function inputs() {
  const [
    ...
    inventory, regionalMap, molitMap, daeguAccessibility, seoulSnapshotBytes,
  ] = await Promise.all([
