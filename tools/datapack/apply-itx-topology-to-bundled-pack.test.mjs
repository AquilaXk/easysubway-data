...
test("expired schedule source는 fresh semantic topology-only admission으로만 계승한다", async () => {
  ...
  documents.reference.promotion = {
    mode: "UNCHANGED_AUTO",
    previousArtifactSha256: documents.reference.sha256,
    previousArtifactPath: documents.reference.artifactPath,
    approvalUrl: null,
