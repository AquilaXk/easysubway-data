...
- A등급(제품/운영 위험: 데이터 정확성, 접근성 시설 근거, 지원 범위 claim, datapack release, data contract(contracts/**, contracts.lock.json), product gate JSON(release/product-gates/**), CI workflow·계약 테스트 변경): .github/PULL_REQUEST_TEMPLATE/full.md 내용으로 교체합니다.
...
- 이 레포 소유 범위: tools/{datapack,route-map,routes,release,ci,lib}/**, contracts/**, release/product-gates/**.
